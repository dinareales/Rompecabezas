...
var instrucciones = ["Utiliza las flechas del teclado para poder mover las piezas","Ordena las piezas hasta alcanzar la imagen objetivo", "Diviertete"];
...
function mostrarUltimoMovimiento(dirección) {
  movimientos.push(dirección);
  actualizarUltimoMovimiento(dirección);
}
...
function chequearSiGano() {
  var grillaOrdenada = [
    ...
    if (grillaOrdenada.length !== grilla.length) 
      return false;
